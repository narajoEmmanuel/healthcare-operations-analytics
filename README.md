...
- [`python/data_dictionary_analysis.ipynb`](python/data_dictionary_analysis.ipynb): executable schema reconciliation and variable profiling against a limited CMS API sample
